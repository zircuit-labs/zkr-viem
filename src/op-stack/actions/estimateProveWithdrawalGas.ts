...
export type EstimateProveZircuitWithdrawalGasReturnType = bigint
export type EstimateProveZircuitWithdrawalGasErrorType =
  | EstimateContractGasErrorType
  | ErrorType
 ...
 * Estimates gas required to prove a withdrawal that occurred on an L2.
 *
 * - Docs: https://viem.sh/op-stack/actions/estimateProveZircuitWithdrawalGas
 *
 * @param client - Client to use
 * @param parameters - {@link EstimateProveZircuitWithdrawalGasParameters}
 * @returns Estimated gas. {@link EstimateProveZircuitWithdrawalGasReturnType}
 *
 * @example
 * import { createPublicClient, http, parseEther } from 'viem'
 * import { base, mainnet } from 'viem/chains'
 * import { estimateProveZircuitWithdrawalGas } from 'viem/op-stack'
 *
 * const client = createPublicClient({
 *   chain: mainnet,
 *   transport: http(),
 * })
 *
 * const gas = await estimateProveZircuitWithdrawalGas(client, {
 *   account: '0xA0Cf798816D4b9b9866b5330EEa46a18382f251e',
 *   l2OutputIndex: 4529n,
 *   outputRootProof: { ... },
 *   targetChain: optimism,
 ...
 * })
 */
export async function estimateProveZircuitWithdrawalGas<
  chain extends Chain | undefined,
  account extends Account | undefined,
  chainOverride extends Chain | undefined = undefined,
>(
  client: Client<Transport, chain, account>,
  parameters: EstimateProveZircuitWithdrawalGasParameters<
    chain,
    account,
    chainOverride
  >,
